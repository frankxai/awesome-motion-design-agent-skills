...
| --- | --- | --- |
| [GSAP](https://github.com/greensock/GSAP) | NOASSERTION · 27,317★ | Modern JavaScript animation. |
| [Motion](https://github.com/motiondivision/motion) | MIT · 33,055★ | React/JavaScript animation. |
| [React Three Fiber](https://github.com/pmndrs/react-three-fiber) | MIT · 31,609★ | Three.js React renderer. |
| [Phaser](https://github.com/phaserjs/phaser) | MIT · 40,049★ | Real-time web interaction patterns. |
| [Remotion](https://github.com/remotion-dev/remotion) | NOASSERTION · 55,303★ | Programmatic video rendering. |
| [gstack](https://github.com/garrytan/gstack) | MIT · 125,927★ | Design review and QA. |
| [Agent Skills](https://github.com/agentskills/agentskills) | Apache-2.0 · 23,762★ | Documented motion review/handoff. |
